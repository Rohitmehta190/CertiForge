            ...
            <form onSubmit={handleVerify} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-zinc-800 border border-zinc-700 rounded-lg text-white placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-white focus:border-transparent font-mono"
                  required
                />
          ...
          <div className="mt-8 bg-zinc-900 border border-zinc-800 rounded-xl p-6">
            ...
            <div className="bg-zinc-800/50 rounded-lg p-4">
              ...
              <p className="font-mono text-xs text-zinc-400 break-all">
                {typeof window !== 'undefined' ? `${window.location.origin}/verify/[CERTIFICATE_ID]` : '/verify/[CERTIFICATE_ID]'}
              </p>
            </div>
          </div>
        </div>
